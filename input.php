...
<body>
    ...
    <video id="example_video" class="video-js vjs-big-play-centered vjs-default-skin" controls preload="auto" width="800" height="480" data-setup="{}">
  ...
  <form method="post" action="submit.php">
    ...
    <div class="form-group row">
      <div class="col-xs-2">
        ...
        <input type="text" name="start[]" class="form-control " placeholder="Start time" id='start' />
      </div>
      <div class="col-xs-2">
        
         <input type="text" name="end[]" class="form-control " placeholder="End time" id='end' />
      </div>
      <div class="col-xs-5">
    ...
    var time;
            ...
            $("body").on("click","#start",function(){
             ...
             $("body").on("click","#end",function(){ 
              var t=Math.floor(myPlayer.currentTime(time));
                  // console.log(t);
                 // $('body').find('.fieldGroup #end').val(t);
                 $(this).val(t);
            });
